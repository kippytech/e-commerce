...
function ProductDetails({ product }: ProductDetailsProps) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col gap-1 text-slate-500">
            ...
            <Horizontal />
            <div>
                <span className="font-semibold">CATEGORY:</span><span className='ml-2'>{product.category}</span>
            </div>
            <div>
                <span className="font-semibold">BRAND:</span><span className='ml-2'>{product.brand}</span>
            </div>
